...
public class Member_Individual extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EditText m_id = (EditText)findViewById(R.id.member_individual_id);
        m_id.setImeOptions(EditorInfo.IME_ACTION_NEXT);
        m_id.setOnEditorActionListener(new TextView.OnEditorActionListener()
        {
            @Override
